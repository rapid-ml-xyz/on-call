from on_call.modules import Conclusion, FeatureAnalyses, FeatureSummary, FeatureVisualizations, \
    FlagCriticalWindows, ImportsModule, TimeSeriesReports, TimeSeriesSummary, WindowVisualizations
...
def setup_analysis_workflow() -> LangGraphOrchestrator:
    ...
    steps = [
        ...
        for step, module in [
            ...
            (Step.FEATURE_SUMMARY, FeatureSummary),
